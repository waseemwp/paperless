                    ...
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-menu">
                        <i class="fa fa-bars"></i>
                            ...
                            <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>">
                                ...
                                <img src="<?php echo esc_url($earna_options['logo']['url']); ?>" class="logo logo-display" alt="Logo">
                                <img src="<?php echo esc_url($earna_options['sticky-logo']['url']); ?>" class="logo logo-scrolled" alt="Logo">
                            </a>
                        </div>
